...
* Use consistent neutral lighting with no flickering or color changes.
...
Do not switch to photorealistic, glossy 3D, painterly, or low-poly rendering.
...
clothing, and equipment move naturally.
...
the running cycle. Do not add attacks, gestures, facial reactions, objects,
